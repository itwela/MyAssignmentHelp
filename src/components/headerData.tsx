...
interface SectionData {
  ...
  const sectionData: SectionData = {
    ...
    Reviews: [
    "<li>MyAssignmenthelp.com has garnered nothing but praise from the clients. Any trustworthy review platform has positive review about our service and gives us motivation to improve.</li>", 
    ],
    About: [
    "<li>MyAssignmenthelp.com helps you to stay at the top of the class with online assignment help. The reason we have been the go to place for urgent assignment help is our pool of finest assignment writing experts for all academic assignments. Our assignment helpers have great writing skills and run a comprehensive assignment check to provide you with custom online assignment help. </li>"
    ],
    Resources: [
